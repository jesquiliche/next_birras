  ...
  return (
   <MagicMotion>
      <aside    
        ...
        className="bg-gray-300 rounded-lg shadow-lg p-4 block sm:hidden"
      >
        <div
          style={{
            display: "flex",
        ...
        <li key={item.id} style={{
          ...
          <Link href={item.path} className="flex items-center">
           {item.icon}
            <h1 className="ml-2 font-semibol px-4 py-1 rounded-lg hover:bg-gray-800 hover:text-white" style={{ lineHeight: '20px' }}>{item.name}</h1>
          </Link>
        </li>
